...
<section class="text-gray-700 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
      ...
      <div class="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
        <h1 class="sm:w-2/5 text-gray-900 font-medium title-font text-2xl mb-2 sm:mb-0">Products</h1>
    ...
    <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
      <img alt="feature" class="object-contain object-center h-full w-full" src="~/assets/blockchain/blockchain_gateway.jpeg">
    </div>
...
<section class="text-gray-700 body-font">
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    ...
    <div class="flex flex-col flex-wrap rg:py-6 -mb-10 lg:w-1/2 rg:pl-12 lg:text-left text-center">
      <div class="flex flex-col mb-10 lg:items-start items-center">
        <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5">
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6" viewBox="0 0 24 24">
            <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
    ...
    <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
    <a  v-on:click="openLightBox">
      <img alt="feature" class="object-contain object-center h-full w-full" src="~/assets/blockchain/block_explorer.jpeg">
      </a>
...
export default {
    ...
    methods:{
        openLightBox:function(event){
            var el = event.target.getElementsByTagName('img')[0];
            console.log(event);
        }
    }
}
